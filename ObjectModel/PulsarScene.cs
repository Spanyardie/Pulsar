...
namespace Pulsar.ObjectModel
{
    public class PulsarScene : Scene
    {
        ...
        private void CreateSceneLight()
        {
            ...
            SceneLight.BaseEntity.IsSystem = true;
        }
        ...
        public void CreateWirePlane()
        {
            ...
            entity.BaseEntity.IsSystem = true;
        }
