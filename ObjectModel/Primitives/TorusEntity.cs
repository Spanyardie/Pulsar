...
{
    public class TorusEntity : Torus
    {
        ...
        public TorusEntity(PulsarScene scene, PulsarApplication application)
        {
            _scene = scene;
        ...
        public TorusEntity(PulsarScene scene, PulsarApplication application, DebugRenderer debugRenderer)
        {
            _scene = scene;
            _application = application;
